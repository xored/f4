...
public class F4Application implements IApplication, IExecutableExtension {
     ...
     */
	public static final String PLUGIN_ID = "com.xored.f4.ide"; //$NON-NLS-1$

    /**
     * Creates a new IDE application.
     */
    public F4Application() {
