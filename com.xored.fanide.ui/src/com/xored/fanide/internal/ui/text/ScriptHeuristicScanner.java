...
public abstract class ScriptHeuristicScanner implements ISymbols {
	 ...
	 */
	public int findClosingPeer(int start, int depth, final char openingPeer, final char closingPeer) {
		return findClosingPeer(start, depth, UNBOUND, openingPeer, closingPeer);
	}
	 ...
	 * @return the matching peer character position, or <code>NOT_FOUND</code>
	 */
	public int findClosingPeer(int start, int depth, int bound, final char openingPeer,
		...
		try {
			...
			while (backwordstart != NOT_FOUND) {
				backwordstart = scanBackward(backwordstart, UNBOUND, new CharacterMatch(
